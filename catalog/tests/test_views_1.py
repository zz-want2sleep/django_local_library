...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_user1 = User.objects.create_user(
            username='testuser1', password='12345', email='1@qq.com')
        test_user1.save()
        test_user2 = User.objects.create_user(
            username='testuser2', password='12345', email='2@qq.com')
        test_user2.save()
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_borrowed_book(self):
        ...
        resp = self.client.get(reverse(
            'catalog:renew-book-librarian', kwargs={'pk': self.test_bookinstance2.pk, }))
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        ...
        # self.assertEquals(test_uid, self.test_bookinstance2.pk)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(resp, reverse('catalog:all-borrowed') + '?m=1')
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'renewal_date', '无效的日期 - 无法采用过去的时间段')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertFormError(resp, 'form', 'renewal_date', '无效的日期 - 续借超过4周')